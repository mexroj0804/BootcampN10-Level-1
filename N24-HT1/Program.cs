...
userService.Get(10, 3).ForEach(user => Console.WriteLine($"{user.Id} - {user.FirstName} {user.LastName} - {user.EmailAdress} - {user.IsDeleted}"));

string keyword;
Console.Write("Enter keyword for search: ");
keyword = Console.ReadLine();
userService.Search(keyword, 10, 1).ForEach(user => Console.WriteLine($"{user.Id} - {user.FirstName} {user.LastName} - {user.EmailAdress} - {user.IsDeleted}"));